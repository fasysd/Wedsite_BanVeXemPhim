            ...
            <main class="col-lg-10 p-4">
                <div class="d-flex justify-content-between align-items-start align-items-md-center mb-4 gap-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">Giao diện form thêm lịch chiếu, chưa gửi dữ liệu về controller.</p>
                    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <select class="form-control">
                                    ...
                                    <option>Cuộc chiến rạp chiếu</option>
                                    <option>Thiên nhiên đen tối</option>
