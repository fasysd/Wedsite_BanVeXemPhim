        ...
        <div class="row">
            <aside class="col-lg-2 sidebar p-3">
                <div class="mb-4 text-white">
                    ...
                    <small class="text-muted">Thêm phim mới</small>
                </div>
            ...
            <main class="col-lg-10 p-4">
                <div class="d-flex justify-content-between align-items-start align-items-md-center mb-4 gap-3">
                    <div>
                        <h4 class="mb-1">Thêm phim mới</h4>
                        <p class="text-muted mb-0">Giao diện form thêm phim, chưa gửi dữ liệu về controller.</p>
                    </div>
                    ...
                    <form onsubmit="event.preventDefault()">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="Hành động, tình cảm...">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control">
                                    ...
                                    <option>Chuẩn bị chiếu</option>
                                    <option>Ngừng chiếu</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Ảnh bìa</label>
                                <input type="text" class="form-control" placeholder="URL ảnh bìa hoặc tên file">
                            </div>
                            <div class="col-12">
                                <label class="form-label">Mô tả</label>
                                <textarea class="form-control" rows="5" placeholder="Nhập mô tả phim"></textarea>
                            </div>
                        </div>
