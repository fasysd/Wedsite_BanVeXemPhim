...
|--------------------------------------------------------------------------
*/
Route::get('/', [MovieController::class, 'index'])->name('user.index');
...
Route::get('/welcome', function () {
    ...
    Route::get('purchase_result', function () {
        return view('movie.purchase_result');
    })->name('ticket.result');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/movies/{movie}/purchase', [TicketController::class, 'purchase'])
        ->name('ticket.purchase');

    Route::post('/movies/{movie}/ticket_store', [TicketController::class, 'store'])
        ->name('ticket.store');
});
...
Route::middleware(['auth', 'staff'])
    ...
    ->group(function () {
        ...
        Route::get('/tickets', [StaffController::class, 'tickets'])
            ->name('tickets');

        Route::get('/tickets/{ticket}', [StaffController::class, 'show'])
            ->name('tickets.show');

        Route::post('/tickets/{ticket}/status', [StaffController::class, 'updateStatus'])
...
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        */
        ...
        Route::put('/staff/{staff}/reset-password', [AdminStaffController::class, 'resetPassword'])
